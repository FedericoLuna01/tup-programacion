...
/*
Al programa del ejercicio anterior agregarle una nueva funcionalidad para que también pueda buscarse a una persona por apellido+nombre, realizar una búsqueda dicotómica
*/
